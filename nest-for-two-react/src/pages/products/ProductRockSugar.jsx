              ...
              >
                ...
                >
                  ...
                  <div className="font-source-sans text-[14px] leading-relaxed" style={{ color: '#636260' }}>
                    ...
                    <p>
                      If you select <span className="font-semibold" style={{ color: '#B76E79' }}>Sugar on the Side</span>, we will provide the Rock Sugar sachets separately so you can adjust the sweetness to your liking. 6 Rock Sugar sachets will be given.
                    </p>
                  </div>
                  <button
                    type="button"
