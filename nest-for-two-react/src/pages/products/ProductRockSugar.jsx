...
const ProductRockSugar = () => {
  const product = PRODUCTS.ROCK_SUGAR;
          ...
          <div className="space-y-6 bg-white p-8 rounded-lg shadow-md">
            ...
            <div className="border-t border-gray-200 mt-6">
              <CollapsibleSection title="Description" defaultOpen={true}>
                <p className="mb-3">
                  Our Rock Sugar Sachet is the traditional favorite, especially beloved by the elderly
                  for its classic, authentic taste. We use pure rock sugar to sweeten premium Indonesian
                  bird's nest, creating a perfect balance of flavor and nutrition.
                </p>
                <p className="mb-3">
                  Each bottle contains thick, authentic bird's nest strands prepared using traditional
                  methods. No preservatives, no artificial additives - just the timeless combination
                  of bird's nest and rock sugar that has been cherished for generations.
                </p>
                <p>
                  Perfect for those who appreciate traditional flavors and seeking to support longevity,
                  vitality, and overall wellness as they age gracefully.
                </p>
              </CollapsibleSection>
              ...
              <CollapsibleSection title="Storage & Consumption">
                ...
                <p className="mb-3">
                  ...
                  for best taste, or warm gently if preferred. Many prefer it slightly warm for a
                  soothing, traditional experience.
                </p>
                <p>
              ...
              <CollapsibleSection title="Ingredients & Benefits">
                <p className="mb-3">
                  <strong>Ingredients:</strong> Premium Indonesian bird's nest, pure rock sugar, purified
                  water. No preservatives, no artificial additives.
                </p>
                <p className="mb-3">
                  <strong>Benefits:</strong>
                </p>
                <ul className="list-disc list-inside space-y-2 ml-4">
                  <li>Supports longevity and healthy aging</li>
                  <li>Strengthens immune system</li>
                  <li>Improves respiratory health and lung function</li>
                  <li>Promotes skin renewal and elasticity</li>
                  <li>Enhances energy and vitality</li>
                  <li>Supports digestive health</li>
                  <li>Traditional flavor beloved for generations</li>
                </ul>
              </CollapsibleSection>
            </div>
          </div>
...
export default ProductRockSugar;
