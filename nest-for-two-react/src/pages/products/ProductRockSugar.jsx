          ...
          <div className="space-y-6 bg-white pt-0 pb-6">
              ...
              >
                ...
                >
                  ...
                  <div className="font-source-sans text-[14px] leading-relaxed" style={{ color: '#636260' }}>
                    ...
                    <p>
                      If you select <span className="font-semibold" style={{ color: '#B76E79' }}>Sugar on the Side</span>, we will provide the Rock Sugar sachets separately so you can adjust the sweetness to your liking. {purchaseType === 'subscription' ? '30' : '6'} Rock Sugar sachets will be given.
                    </p>
                  </div>
                  <button
                    type="button"
              ...
              <div className="flex justify-between items-center">
                ...
                <div className="text-right">
                  {currentVariant?.originalPrice && (
                    <span className="font-source-sans text-lg line-through mr-2" style={{ color: '#9ca3af' }}>
                      ${(currentVariant.originalPrice * quantity).toFixed(2)}
                    </span>
                  )}
            ...
            <div className="mt-6">
              ...
              <CollapsibleSection title="HOW TO CONSUME YOUR BIRD'S NEST">
                <img
                  src="/images/HTC_RockSugar_Bottle.png"
