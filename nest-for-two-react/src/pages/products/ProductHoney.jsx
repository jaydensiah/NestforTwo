              ...
              >
                ...
                >
                  ...
                  <div className="font-source-sans text-[14px] leading-relaxed" style={{ color: '#636260' }}>
                    ...
                    <p>
                      If you select <span className="font-semibold" style={{ color: '#B76E79' }}>Honey on the Side</span>, we will provide the Honey sachets separately so you can adjust the sweetness to your liking. {purchaseType === 'subscription' ? '30' : '6'} Honey sachets will be given.
                    </p>
                  </div>
                  <button
                    type="button"
